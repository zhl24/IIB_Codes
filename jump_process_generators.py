...
#Generator for Gamma process (more important). Defined by beta and C. Again T is the simulation time for the generator. Note that the evaluatioins points start from 0 wrt T interval.
...
#The most important generator in this project
